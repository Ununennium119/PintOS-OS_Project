...
سیستم عامل به ازای هر پراسس یک جدول دارد که شامل
fdهای
مربوط به آن پراسس است. هز fd به آن فایل باز شده اشاره دارد.
fdهای یک پراسس منحصر به فرد هستند اما در سیستم‌عامل اینگونه نیست
یعنی برای مثال 
دوتا پراسس جدا می‌تواند دو fd با شماره ۵ داشته باشند که به فایل‌های متفاوتی اشاره می‌کنند.
