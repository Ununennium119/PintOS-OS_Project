...
۲ دلاک داریم.
در مرحله اخر که باید lock1 ریلیز میشود به دست ترد c بیفتد تا زودتر lock2 را برای a ریلیز کند، این اتفاق نمیفتد چون تابع sema_up مشکل دارد و ابتدا ترد b اجرا میشود و سپس نوبت به c میرسد!
